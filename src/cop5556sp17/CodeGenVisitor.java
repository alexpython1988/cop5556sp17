...
//				fv = cw.visitField(0, decIdent, "I", null, null);fv.visitEnd();
//			}else if(tn.isType(BOOLEAN)){
//				fv = cw.visitField(0, decIdent, "Z", null, null);fv.visitEnd();
//			}			
//		}
...
//			mv.visitVarInsn(ALOAD, 0);
	...
	public Object visitParamDec(ParamDec paramDec, Object arg) throws Exception {
		...
		((MethodVisitor) arg).visitLdcInsn(paramDecCounter);
		...
		if(type.isType(TypeName.INTEGER)){
			...
			((MethodVisitor) arg).visitFieldInsn(PUTFIELD, className, paramDec.getIdent().getText(), "I");
			...
			((MethodVisitor) arg).visitFieldInsn(PUTFIELD, className, paramDec.getIdent().getText(), "Z");
		}		
